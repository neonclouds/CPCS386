...
def check_highscore_button(ai_settings, screen, stats, sb, highscore_button, ship, aliens, bulelts, mouse_x, mouse_y):
    button_clicked = highscore_button.rect.collidepoint(mouse_x, mouse_y)
    if button_clicked and not stats.game_active:
        if highscore_button.rect.collidepoint(mouse_x, mouse_y):
            sb.prep_high_score()
...
def check_events(ai_settings, screen, stats, sb, play_button, highscore_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_highscore_button(ai_settings, screen, stats, sb, highscore_button, ship, aliens, bullets, mouse_x, mouse_y)
